...
config :availabit_web, AvailabitWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "8q6rugF6to4oP93NQwVMM8qTC5Ksv8xEsVMcVPoohYuK+8bx2lIf+MuWMPA3nWgF",
...
config :ueberauth, Ueberauth.Strategy.Github.OAuth,
  client_id: "9efbad60bfd17447d191",
  client_secret: "b4e964723f861e574333a281d666411ba7f9509c"
